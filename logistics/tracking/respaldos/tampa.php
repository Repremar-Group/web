<html>
	...
	<body bgcolor="" leftmargin="0" topmargin="0">
		...
		<form method="post" name="Form0" action="https://tacacargo.mercator.com/skychain/app">
		...
		<form method="post" name="Form1" target="_blank" action="https://tacacargo.mercator.com/skychain/app" listener="SyntheticListener[com.emirates.ngcs.nweb.trackshipment.TrackShipmentPage$Enhance_10@ec744f0[nwp:Trackshipmt] public void com.emirates.ngcs.nweb.trackshipment.TrackShipmentPage.formSubmit(org.apache.tapestry.IRequestCycle)]">
		  ...
		  <table width="645" border="0" cellspacing="0" cellpadding="0">
			...
			<tr> 
					  ...
					  <td width="79" bgcolor="#FFFFFF"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif" class="letras">TAMPA</font></td>
					  <td bgcolor="#FFFFFF">&nbsp;</td>
			</tr>
			<tr>
					<td>&nbsp;</td>
			...
			<tr> 
			  <td height="19">&nbsp;</td>
			  <td bgcolor="#FFFFFF"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif" class="letras">Prefijo:</font></td>
			  <td bgcolor="#FFFFFF"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif" class="letras">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
				</font></td>
			  <td bgcolor="#FFFFFF"> <input type="text" name="txtPrefix" value="729" dataType="NUMBER" title="AWB Prefix" onblur="onBlur_FieldClassChange(this,'NUMBER','');" onfocus="onFocus_FieldClassChange(this,'NUMBER','');" maxlength="3" size='1' readonly='readonly'/>
			  </td>
			...
			<tr> 
			  ...
			  <td bgcolor="#FFFFFF">&nbsp;</td>
			  <td bgcolor="#FFFFFF"><input type="text" name="txtNumber" dataType="AWBSERIAL" title="AWB Number" style="width:65px;text-transform:uppercase" onblur="onBlur_FieldClassChange(this,'AWBSERIAL','');" onfocus="onFocus_FieldClassChange(this,'AWBSERIAL','');" onchange="_awbValidation(this)" maxlength="8" size='6'/></td>
			</tr>
			<tr> 
			  <td height="19">&nbsp;</td>
			  <td colspan="3" bgcolor="#FFFFFF">&nbsp;</td>
			...
			<tr> 
			  ...
			  <td bgcolor="#FFFFFF">&nbsp;</td>
			  <td bgcolor="#FFFFFF">&nbsp;</td>
			  <td bgcolor="#FFFFFF"><input type="submit" name="$Submit" value="Buscar" title="Track"/></td>
			</tr>
		  </table>  <p>&nbsp; </p>
