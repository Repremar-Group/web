...
<body>
<div class="header">
  <div class="logo"> <img class="img_logo" src="img/cargo_tracking_logo.png" /> 
...
<div class="content">
  ...
  <div id="contenido_maritimo" style="display:none;">
	...
	<font size="2">(*) Redirects to the carrier's web.<br>
	(**) Login required within carrier's web.</font>
  </div>
