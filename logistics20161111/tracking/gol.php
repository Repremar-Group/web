<html>
	...
	<body bgcolor="" leftmargin="0" topmargin="0">
		<FORM ACTION="http://g3cs.uesc.com/dsse2.asp" METHOD="post" NAME="dsse" TARGET="_blank" onSubmit="return Valdss(this);">
		<input accesskey=A type=hidden value=0 checked name=opt onClick='Change_input()'>
		  <table width="645" border="0" cellspacing="0" cellpadding="0">
			...
			<tr> 
					  ...
					  <td width="79" bgcolor="#FFFFFF"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif" class="letras">GOL</font></td>
					  <td bgcolor="#FFFFFF">&nbsp;</td>
			</tr>
			<tr>
					<td>&nbsp;</td>
			...
			<tr> 
			  ...
			  <td bgcolor="#FFFFFF"> <input type="text" size="1" maxlength="3" name="inacn" value="127" readonly class="signin" tabIndex=8 title="Insira o Código ACN do AWB">
			  </td>
			...
			<tr> 
			  ...
			  <td bgcolor="#FFFFFF">&nbsp;</td>
			  <td bgcolor="#FFFFFF"><input type="text" size="6" maxlength="8" name="inref" value="" class="signin" tabIndex=9 title="Conhecimento Aéreo">
			  
				<DIV valign="top" id="mulTrack" style="display:none;">
			...
			<tr> 
			  ...
			  <td bgcolor="#FFFFFF">&nbsp;</td>
			  <td bgcolor="#FFFFFF">&nbsp;</td>
			  <td bgcolor="#FFFFFF"><input type="submit" value="Buscar"/>
			</tr>
		  </table>  <p>&nbsp; </p>
